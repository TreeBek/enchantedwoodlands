...
public class WorldGenMinableSlimeValley extends WorldGenerator
{
    ...
    public WorldGenMinableSlimeValley(int par1, int par2)
    {
        this(par1, par2, Blocks.mythicalStone.blockID);
    }

    public WorldGenMinableSlimeValley(int par1, int par2, int par3)
    {
    ...
    public WorldGenMinableSlimeValley(int id, int meta, int number, int target)
    {
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int i3 = k1; i3 <= j2; ++i3)
                            {
                                ...
                                {
                                    par1World.setBlock(k2, l2, i3, minableBlockId, minableBlockMeta, 2);
                                }
                            }
                        }
                    }
