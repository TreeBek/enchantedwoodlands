...
public class WorldChunkMangerDim extends WorldChunkManager
{
	...
	protected WorldChunkMangerDim()
	{
		...
		this.myBiomesToSpawnIn.add(Dimension.Biome1);
		this.myBiomesToSpawnIn.add(Dimension.Biome2);
	...
	public WorldChunkMangerDim(long seed, WorldType worldtype)
	{
		...
		GenLayer[] agenlayer = GenLayerBiomesDim.makeTheWorld(seed);
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
		...
		for (int i = 0; i < par4 * par5; ++i) {
			if (aint[i] >= 0) {
				...
				par1ArrayOfBiomeGenBase[i] = Dimension.Biome1;
			}
		}
