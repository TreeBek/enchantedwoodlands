...
public class ChunkProviderDim implements IChunkProvider {
	...
	public ChunkProviderDim(World world, long seed, boolean mapFeaturesEnabled) {
		this.worldObj = world;
					...
					for (int l1 = 0; l1 < 8; ++l1) {
						...
						for (int i2 = 0; i2 < 4; ++i2) {
							...
							for (int k2 = 0; k2 < 4; ++k2) {
								if ((d16 += d15) > 0.0D) {
									par3ArrayOfByte[j2 += short1] = (byte) Blocks.mythicalStone.blockID;//Block.stone.blockID;
								} else if (k1 * 8 + l1 < b2) {
