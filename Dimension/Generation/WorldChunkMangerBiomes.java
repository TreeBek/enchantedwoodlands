...
public class WorldChunkMangerBiomes extends WorldChunkManager
{
...
protected WorldChunkMangerBiomes()
{
this.myBiomeCache = new BiomeCache(this);
this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
this.myBiomesToSpawnIn.add(Dimensions.Biome1);
this.myBiomesToSpawnIn.add(Dimensions.Biome2);
}

public WorldChunkMangerBiomes(long seed, WorldType worldtype)
{
this();
// i changed this to my GenLayerTutorial
GenLayer[] agenlayer = GenLayerBiomes.makeTheWorld(seed);
this.myGenBiomes = agenlayer[0];
this.myBiomeIndexLayer = agenlayer[1];
}

public WorldChunkMangerBiomes(World world)
{
...
par1ArrayOfBiomeGenBase[i] = Dimensions.Biome1;
}
}
