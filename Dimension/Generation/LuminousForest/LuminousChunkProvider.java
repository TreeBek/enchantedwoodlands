...
public class LuminousChunkProvider implements IChunkProvider {
	/** RNG. */
	private Random rand;
	...
	public LuminousChunkProvider(World world, long seed, boolean mapFeaturesEnabled) {
		this.worldObj = world;
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        for (int c = 60; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Blocks.woodlandGrass.blockID))
                {
                        new WorldGenTestTree(true, 6 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Blocks.woodlandGrass.blockID))
                {
                        new WorldGenTestTree(true, 4 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Blocks.woodlandGrass.blockID))
                {
                        new WorldGenTestTree(true, 8 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Blocks.woodlandGrass.blockID))
                {
                        new WorldGenTestTree(true, 10 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Blocks.woodlandGrass.blockID))
                {
                        new WorldGenTestTree(true, 15 + rand.nextInt(4), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 60; c > 0; c--)
        {
        ...
        for (int c = 15; c > 0; c--)
        {
                ...
                int l3 = rand.nextInt(120);
                int j5 = l + rand.nextInt(16) + 8;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Blocks.starDustGrass.blockID))
                {
                        new WorldGenExepditeTree(true, 6 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
