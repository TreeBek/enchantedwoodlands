...
public abstract class LuminousGenLayerBiomes extends GenLayer
{
public LuminousGenLayerBiomes(long seed) {
super(seed);
}

public static GenLayer[] makeTheWorld(long seed) {

GenLayer biomes = new LuminousGenLayerBiomesBiomes(1L);
