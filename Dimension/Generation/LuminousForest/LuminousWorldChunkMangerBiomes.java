...
public class LuminousWorldChunkMangerBiomes extends WorldChunkManager
{
...
protected LuminousWorldChunkMangerBiomes()
{
...
GenLayer[] agenlayer = LuminousGenLayerBiomes.makeTheWorld(seed);
this.myGenBiomes = agenlayer[0];
this.myBiomeIndexLayer = agenlayer[1];
}

public LuminousWorldChunkMangerBiomes(World world)
{
...
if (biome == null)
{
return Dimensions.WoodlandForest;
}
...
par1ArrayOfBiomeGenBase[i] = Dimensions.WoodlandForest;
}
}
