...
this.worldChunkMgr = new WorldChunkMangerBiomes(worldObj.getSeed(), terrainType);
this.hasNoSky = false;
}
@Override
...
{
return "Entering the Enchanted Woodlands Dimension";
}
...
{
return "Building Enchanted Woodlands Dimension";
}
