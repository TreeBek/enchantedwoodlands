...
public class WorldGenMythicFlowers extends WorldGenerator
{
    ...
    public WorldGenMythicFlowers(int par1, int par2)
    {
        this(par1, par2, Blocks.starDustGrass.blockID);
    }

    public WorldGenMythicFlowers(int par1, int par2, int par3)
    {
    ...
    public WorldGenMythicFlowers(int id, int meta, int number, int target)
    {
