...
public class WorldGenTestHugeTree extends WorldGenerator
{
    ...
    public WorldGenTestHugeTree(boolean par1, int par2, int par3, int par4)
    {
        super(par1);
                    ...
                    for (k1 = par5 - b0; k1 <= par5 + b0 && flag; ++k1)
                    {
                        if (i1 >= 0 && i1 < 256)
                        {
                            ...
                            if (l1 != 0 &&
                               ...
                               l1 != Blocks.woodlandSapling.blockID)
                            {
                                flag = false;
                            }
                        }
                ...
                if (isValidSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (int i2 = par4 + l - 2 - par2Random.nextInt(4); i2 > par4 + l / 2; i2 -= 2 + par2Random.nextInt(4))
                    {
                        ...
                        for (int j2 = 0; j2 < 5; ++j2)
                        {
                            ...
                            this.setBlockAndMetadata(par1World, k1, i2 - 3 + j2 / 2, l1, Blocks.woodlandLog.blockID, this.woodMetadata);
                        }
                    }
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, Blocks.woodlandLog.blockID, this.woodMetadata);
                        ...
                        if (j1 < l - 1)
                        {
                            ...
                            {
                                this.setBlockAndMetadata(par1World, par3 + 1, par4 + j1, par5, Blocks.woodlandLog.blockID, this.woodMetadata);
                            ...
                            {
                                this.setBlockAndMetadata(par1World, par3 + 1, par4 + j1, par5 + 1, Blocks.woodlandLog.blockID, this.woodMetadata);
                            ...
                            {
                                this.setBlockAndMetadata(par1World, par3, par4 + j1, par5 + 1,Blocks.woodlandLog.blockID, this.woodMetadata);
            ...
            for (int l1 = par2 - k1; l1 <= par2 + k1 + 1; ++l1)
            {
                ...
                for (int j2 = par3 - k1; j2 <= par3 + k1 + 1; ++j2)
                {
                    ...
                    if ((i2 >= 0 || k2 >= 0 || i2 * i2 + k2 * k2 <= k1 * k1) && (i2 <= 0 && k2 <= 0 || i2 * i2 + k2 * k2 <= (k1 + 1) * (k1 + 1)) && (par6Random.nextInt(4) != 0 || i2 * i2 + k2 * k2 <= (k1 - 1) * (k1 - 1)))
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, l1, i1, j2, Blocks.woodlandLeaf.blockID, this.leavesMetadata);
                        }
                    }
                }
            }
