...
public class WorldGenTestForestTree extends WorldGenerator
{
	public WorldGenTestForestTree(boolean par1)
	{
		super();
	}
			...
			else
			{
				...
				if (isValidSoil && par4 < 256 - l - 1)
				{
						...
						for (l1 = par3 - k1; l1 <= par3 + k1; ++l1)
						{
							...
							for (int k2 = par5 - k1; k2 <= par5 + k1; ++k2)
							{
								...
								if (Math.abs(j2) != k1 || Math.abs(l2) != k1 || par2Random.nextInt(2) != 0 && j1 != 0)
								{
									...
									{
										this.setBlockAndMetadata(par1World, l1, i2, k2, Blocks.starDustLeaf.blockID, 0);
									}
								}
							}
						}
					...
					for (i2 = 0; i2 < l; ++i2)
					{
						...
						{
							this.setBlockAndMetadata(par1World, par3, par4 + i2, par5,Blocks.starDustLog.blockID, 0);
						}
					}
