...
public class BlockTestSapling extends BlockFlower
{
	/** change the name to your sapling name **/
	public static final String[] WOOD_TYPES = new String[] {"EnchantedWoodlands"};

	public BlockTestSapling(int i, int j)
	{
		super(i);
		float var3 = 0.4F;
    ...
    {
            blockIcon = iconRegister.registerIcon(Common.modid.toLowerCase() + ":" + this.getUnlocalizedName().substring(5));
    }
