...
public ChunkProviderDim(World par1World, long par2, boolean par4) {
...
for (int k1 = 0; k1 < b1; ++k1)
{
         ...
         if ((d16 += d15) > 0.0D)
         {
                 ...
                 par3ArrayOfByte[j2 += short1] = (byte)Blocks.mythicalStone.blockID;//
         }
         else if (k1 * 8 + l1 < b2)
         {
...
for (int var16 = 127; var16 >= 0; var16--)
{
         ...
         /** Main filler block fill's all the underground, replaces block stone **/
         else if (var18 != Blocks.mythicalStone.blockID)
         {
         if (var13 == -1)
         {
         if (var12 == 0)
         {
                 ...
                 var15 = (byte)Blocks.woodlandGrass.blockID;//
         }
