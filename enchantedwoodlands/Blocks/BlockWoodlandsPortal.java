...
import Mod.enchantedwoodlands.Dimension.TeleporterDim;
...
public class BlockWoodlandsPortal extends BlockBreakable
{
public BlockWoodlandsPortal(int par1)
{
super(par1, "EnchantedWoodlands:woodlandsPortal", Material.portal, false);
...
for (i1 = -1; i1 <= 3; ++i1)
{
         ...
         else if (j1 != 0 && j1 != Blocks.woodlandsFire.blockID)
         {
         return false;
         }
         }
...
for (i1 = 0; i1 < 3; ++i1)
{
         par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, Blocks.woodlandsPortal.blockID, 0, 2);
}
}
return true;
}
...
if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
         ...
         else if (thePlayer.dimension != Dimension.DimID)
         {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Dimension.DimID, new TeleporterDim(thePlayer.mcServer.worldServerForDimension(Dimension.DimID)));
         }
         else {
                 thePlayer.timeUntilPortal = 10;
