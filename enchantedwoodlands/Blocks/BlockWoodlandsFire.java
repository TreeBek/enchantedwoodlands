...
public class BlockWoodlandsFire extends BlockFire
{
private int[] chanceToEncourageFire = new int[256];
private int[] abilityToCatchFire = new int[256];
@SideOnly(Side.CLIENT)
private Icon[] iconArray;
public BlockWoodlandsFire(int par1)
{
super(par1);
...
if ((par1World.getBlockId(par2, par3 - 1, par4) != Block.blockDiamond.blockID) || (!Blocks.woodlandsPortal.tryToCreatePortal(par1World, par2, par3, par4)))
{
if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!canNeighborBurn(par1World, par2, par3, par4)))
{
par1World.setBlockToAir(par2, par3, par4);
...
if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!Blocks.woodlandsFire.canBlockCatchFire(par1World, par2, par3 - 1, par4, ForgeDirection.UP)))
{
if (Blocks.woodlandsFire.canBlockCatchFire(par1World, par2 - 1, par3, par4, ForgeDirection.EAST))
{
for (int l = 0; l < 2; l++)
{
...
if (Blocks.woodlandsFire.canBlockCatchFire(par1World, par2 + 1, par3, par4, ForgeDirection.WEST))
{
for (int l = 0; l < 2; l++)
{
...
if (Blocks.woodlandsFire.canBlockCatchFire(par1World, par2, par3, par4 - 1, ForgeDirection.SOUTH))
{
for (int l = 0; l < 2; l++)
{
...
if (Blocks.woodlandsFire.canBlockCatchFire(par1World, par2, par3, par4 + 1, ForgeDirection.NORTH))
{
for (int l = 0; l < 2; l++)
{
float f = par2 + par5Random.nextFloat();
...
if (Blocks.woodlandsFire.canBlockCatchFire(par1World, par2, par3 + 1, par4, ForgeDirection.DOWN))
{
for (int l = 0; l < 2; l++)
{
float f = par2 + par5Random.nextFloat();
