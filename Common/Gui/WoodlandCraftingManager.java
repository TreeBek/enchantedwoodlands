...
public class WoodlandCraftingManager
{
public static final int WILDCARD_VALUE = Short.MAX_VALUE;
private static final WoodlandCraftingManager instance = new WoodlandCraftingManager();
private List recipes = new ArrayList();

public static final WoodlandCraftingManager getInstance()
{
         return instance;
}
...
public WoodlandShapedRecipes func_92051_a(ItemStack par1ItemStack, Object ... par2ArrayOfObj)
{
         ...
         WoodlandShapedRecipes var17 = new WoodlandShapedRecipes(var5, var6, var15, par1ItemStack);
...
public void addBuilderShapelessRecipe(ItemStack par1ItemStack, Object ... par2ArrayOfObj)
{
         ...
         this.recipes.add(new WoodlandShapelessRecipes(par1ItemStack, var3));
}
