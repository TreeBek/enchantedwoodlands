...
public class ContainerWoodlandBench extends Container
{
...
public ContainerWoodlandBench(InventoryPlayer inventoryplayer, World world, int i, int j, int k)
{
...
{
         craftResult.setInventorySlotContents(0, WoodlandCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
}
...
{
         if(worldObj.getBlockId(posX, posY, posZ) != Blocks.woodlandBench.blockID)
         {
                 return false;
         } else
         {
