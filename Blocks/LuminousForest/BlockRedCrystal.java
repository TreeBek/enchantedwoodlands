...
public class BlockRedCrystal extends BlockContainer {

public BlockRedCrystal(int id, int texture, Material material) {
super(id, material);
...
{
return Blocks.redCrystal.blockID;
}
...
{
return new TileEntityRedCrystal();
}
