...
public class BlockWoodlandPortal extends BlockBreakable
{
public BlockWoodlandPortal(int par1)
{
...
for (i1 = -1; i1 <= 3; ++i1)
{
         ...
         else if (j1 != 0 && j1 != Blocks.woodlandFire.blockID)
         {
         return false;
         }
         }
...
for (i1 = 0; i1 < 3; ++i1)
{
         par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, Blocks.woodlandPortal.blockID, 0, 2);
}
}
return true;
}
...
if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
         ...
         else if (thePlayer.dimension != Common.DimID)
         {
                 thePlayer.timeUntilPortal = 10;
                 ...
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new MythicalTeleporter(thePlayer.mcServer.worldServerForDimension(0)));
         }
         }
}
@SideOnly(Side.CLIENT)
