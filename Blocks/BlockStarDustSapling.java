...
public class BlockStarDustSapling extends BlockFlower
{
	/** change the name to your sapling name **/
	public static final String[] WOOD_TYPES = new String[] {"starDustSapling"};

	public BlockStarDustSapling(int i, int j)
	{
		super(i);
		float var3 = 0.4F;
    ...
    {
            blockIcon = iconRegister.registerIcon(Common.modid + ":" + this.getUnlocalizedName().substring(5));
    }
	...
	public void func_96477_c(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if ((l & 8) == Blocks.woodlandGrass.blockID)
		{
	...
	public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		else if (l == 3)
		{
			for (i1 = 0; i1 >= -1; --i1)
			{
				for (j1 = 0; j1 >= -1; --j1)
				{
					if (this.isSameSapling(par1World, par2 + i1, par3, par4 + j1, 3) && this.isSameSapling(par1World, par2 + i1 + 1, par3, par4 + j1, 3) && this.isSameSapling(par1World, par2 + i1, par3, par4 + j1 + 1, 3) && this.isSameSapling(par1World, par2 + i1 + 1, par3, par4 + j1 + 1, 3))
					{
						...
						object = new WorldGenTestTree(true, 10 + par5Random.nextInt(20), 3, 3, false);
						flag = true;
						break;
					}
				}
			...
			if (object == null)
			{
				...
				i1 = 0;
				/** Change this to your WorldGenNAMETree **/
				object = new WorldGenTestTree(true, 4 + par5Random.nextInt(7), 3, 3, false);
			}
		}
		else
		{
			/** Change this to your WorldGenNAMETree **/
			object = new WorldGenTestTree(true); // Changed //
